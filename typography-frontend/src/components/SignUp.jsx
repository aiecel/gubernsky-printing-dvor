                ...
                {() => (
                    <Form>
                        <div className="form-group">
                            <div><label style={{float: 'left'}} htmlFor="exampleInputEmail1">Адрес почтового
                                ящика</label></div>
                            <Field size='50' type="email" name="email"/>
                            <ErrorMessage style={{color: 'red', display: 'flex'}} name="email" component="div"/></div>
                        <div className="form-group">
                            <div><label style={{float: 'left'}} htmlFor="exampleInputEmail1">Ваш потаённый код</label>
                            </div>
                            <Field size='50' type="password" name="password"/>
                            <ErrorMessage style={{color: 'red', display: 'flex'}} name="password" component="p"/></div>
                        <button   className="btn btn-light" type="submit">
                            Зарегистрироваться
                        </button>
                        <div style={{paddingTop: '10px'}}><Link to={'/'}><p className='nav-link'>Уже постоялец
                            двора?</p></Link>
                        </div>
                    </Form>
                )}
