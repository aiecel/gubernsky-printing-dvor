package com.aiecel.gubernskytypography.bot.vk.keyboard;
...
public class KeyboardBuilder {
    ...
    public KeyboardBuilder add(KeyboardButton button) {
    ...
    public KeyboardBuilder add(KeyboardButton button, int row, int column) {
